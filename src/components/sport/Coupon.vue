		...
		<transition name="slide">
			...
			>
				...
				<div class="coupon__info">
					<div class="bet-info">
						<p class="bet-info__name">Исход: П2</p>
						<p class="bet-info__teams">Сан Лоренцо - Сентраль Кордоба СдЕ</p>
						<p class="bet-info__category">Обычная/Спорт/Футбол</p>
					</div>
					<p class="coupon__coefficient">x2.01</p>
				</div>
				<label for="" class="coupon__label">
					<input type="text" class="coupon__input" placeholder="Сумма ставки">
				</label>
